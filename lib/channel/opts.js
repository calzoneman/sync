...
ChannelOptionsModule.prototype.save = function (data) {
    data.opts = this.opts;
};

ChannelOptionsModule.prototype.get = function (key) {
    return this.opts[key];
};

ChannelOptionsModule.prototype.set = function (key, value) {
    this.opts[key] = value;
};

ChannelOptionsModule.prototype.postJoin = function (user) {
    user.socket.on("setOptions", this.handleSetOptions.bind(this, user));

    this.sendOpts([user]);
};

ChannelOptionsModule.prototype.sendOpts = function (users) {
    var opts = this.opts;
...
ChannelOptionsModule.prototype.getPermissions = function () {
